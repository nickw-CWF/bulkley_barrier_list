...
- The layers symbol in the top left corner allows you to switch the basemap, including to satellite imagery (the ``Esri.WorldImagery`` option).
...
Each of the tabs below contains the barrier lists for the individual crossings and then the set of barriers for each system. Click on the tab you are interested in to pull up the associated barrier list. The table for each set of barriers has a gain per barrier value at the bottom of the table.
