---
title: "Bulkley River Watershed - Updated Preliminary Barrier List"
...
individual_crossings = individual_crossings[individual_crossings$aggregated_crossings_id != 197651,]

bulkley_river = barriers_all[barriers_all$barrier_set == 1,]

bulkley_river = bulkley_river[bulkley_river$aggregated_crossings_id != 197972,]
...
graphite_creek = barriers_all[barriers_all$barrier_set == 15,]
...
Barriers ``197967`` and ``197964`` were assessed and included in the shortlist discussion at the last workshop. However, there are other barriers in the system that moved up the list that have substantial potential habitat gains.
...
Barriers ``198066``, ``123377``, and ``123375`` were some of the extra barriers assessed during the 2021 field season.
...
Barrier ``197663`` was included in the shortlist discussion at the last workshop.
...
Barrier ``123770`` was included in the shortlist discussion at the last workshop.
...
Barriers ``197974`` and ``198065`` were some of the extra barriers assessed during the 2021 field season.
...
When looking at imagery, it seems like dam ``1100002524`` is associated with a pond that is not located on the main stream channel.
